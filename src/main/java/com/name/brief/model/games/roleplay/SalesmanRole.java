...
public enum SalesmanRole implements GameRole, PharmaRole {
    SALESMAN_1(
            "Медицинский представитель",
                     ...
                     "<br><br>Вы знаете, что в отличие от многих конкурентов ваши сборы легко доступны в аптеках. Сборы производятся на самом современном оборудовании для обеспечения стабильности состава и качества. Для удобства пациентов все смеси трав расфасованы в одноразовые пакетики.\n" +
